...
var pHome = document.querySelector('[name="p-home"]');
var pGame = document.querySelector('[name="p-game"]');
var pSplashScreen = document.querySelector('[name="p-splash-screen"]');
var pGameLog = document.querySelector('[name="p-game-log"]');
var pSetting = document.querySelector('[name="p-setting"]');
